...
- Search: query_log.py surfaces an ask.py answer; query_opened.py records which hit was opened: writing/query-log.
...
- Tests: python .claude/hooks/test_hooks.py, test_ask_rule_approval.py, test_block_handoff_write.py. Registration: .claude/settings.json.
